...
lyr_OpenStreetMap_0.setVisible(true);lyr_GELUID_VERKEER_1.setVisible(true);lyr_VOGELS_2.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_GELUID_VERKEER_1,lyr_VOGELS_2];
