...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [527060.809113, 6858259.897588, 557957.063293, 6881075.200799], maxZoom: 28, minZoom: 8
    })
});


map.getView().fit([527060.809113, 6858259.897588, 557957.063293, 6881075.200799], map.getSize());
